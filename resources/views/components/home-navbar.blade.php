    ...
    <nav class="bg-white border-gray-200 dark:bg-gray-900">
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl p-4">
            ...
            <div class="flex items-center space-x-6 rtl:space-x-reverse">
                ...
                <a href="{{route('auth.register')}}" class="text-sm  text-blue-600 dark:text-blue-500 hover:underline">SingUp</a>

                @endguest
                @auth


                <div id="avatarButton" type="button" data-dropdown-toggle="userDropdown" data-dropdown-placement="bottom-start" class="relative inline-flex items-center justify-center w-10 h-10 overflow-hidden bg-gray-100 rounded-full dark:bg-gray-600" src="/docs/images/people/profile-picture-5.jpg" alt="User dropdown">
                    <span class="font-medium text-orange-600 dark:text-orange-300 uppercase">{{substr(auth()->user()->name, 0,2)}}</span>
                </div>
                ...
                <a href="{{route('cart')}}" class="relative inline-flex items-center px-3 py-2 text-sm font-medium text-center ring-1 rounded-md">
