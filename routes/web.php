...
Route::prefix("admin")->group(function(){
    Route::get("/", [AdminContoller::class, "dashboard"])->name("admin.dashboard");
...
Route::post("/address/create",[AddressController::class,"store"])->name("address.store")->middleware('auth');

//coupon routes

Route::post('/add-coupon', [OrderController::class,'addCoupon'])->name('coupon.add')->middleware('auth');
Route::get('/remove_coupon', [OrderController::class,'removeCoupon'])->name('coupon.remove')->middleware('auth');
